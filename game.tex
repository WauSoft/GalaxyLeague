...
\input{the-game/the-team.tex}
\input{the-game/skill-rolls.tex}
\input{the-game/moving.tex}
\input{the-game/attacking.tex}
\input{the-game/energy.tex}
%\input{the-game/throwing-passing.tex}
%\input{the-game/special-action.tex}
\input{the-game/flag-interaction.tex}
\input{the-game/scoring.tex}