...
For every person helping you, you get to roll an additional attack die (see \secref{sec:multidice}).
...
\begin{note} 
Because of the movement penalty for getting back up, attacking with a character that's just gotten up requires a \textit{Tackle} (see \secref{energy}).
\end{note}