...
\begin{note}
In the event that multiple players are in a dogpile (see \secref{dogpiling}), all the participating players get to move into the previously occupied hexes as the victor sees fit.
\end{note}
\paragraph{Failure}
